...
x1a=23156159157851561545603156513097 #p32
x2a=59815951546359561595612325859167 #q32
na=x1a*x2a #n
...
x1b=98751594121515465531468455649067 #p
x2b=74591561565484879151354545616473 #q
nb=x1b*x2b # n
...
#voici les éléments de la clé d'Alice
x1a=5041901504594532739647823671795674168764781963651928746817637721 #p64
x2a=3519515844892517921589158908425412501259054259751250142510592837 #q64
na=x1a*x2a  #n
phia=((x1a-1)*(x2a-1))//MW.home_pgcd(x1a-1,x2a-1)
ea=65539 #exposant public
da=MW.home_ext_euclide(phia,ea) #exposant privé
...
print("Bob, vous souhaitez envoyer un secret à Alice")
...
block_size = CBC.SelectBlockSize(na)
...
print(num_sec)
print("Length of nombre decimal : ",len(str(num_sec)))
chif,iv,n_pad,unit_len=CBC.en_CBC(num_sec,ea,na,block_size)
print("voici le random iv:",iv)
print("voici le nombre de digits padding:",n_pad)
print("voici le unit length",unit_len)
...
x=input("appuyer sur entrer")
print("*******************************************************************")
dechif=MW.home_int_to_string(CBC.de_CBC(chif, n_pad, iv, da, na,unit_len,block_size))
