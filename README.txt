===============================================
||	RSA/MD5, RSA/sha256, RSA/CBC, Chinese rest method	||
||		        Author : DU Tianren			||
||		           RS40 2021A TP			||
===============================================
...
==================Usage===================
User Interface is based on original file.
...
====send and receive====
6.a big int number -> separate blocks and RSA decrepy
7.de_CBC(XOR) and de_padding
8.transform int to string ->get the information
9.do hash and match with the signature
...
Method:
	...
	===============
	home_int_to_string(x)	int -> string
